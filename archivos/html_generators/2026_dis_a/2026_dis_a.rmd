...
```{r, echo=FALSE, message=FALSE, fig.width=12, fig.height=5, warning=FALSE}
library(patchwork)
# g1: % hogares biparentales por cantidad de hijos
# g2: % total de hijos por edad del hijo
knitr::include_graphics("graficos/g1.png")
```
...
knitr::include_graphics("graficos/g3.png")
...
knitr::include_graphics("graficos/g4.png")
```
...
knitr::include_graphics("graficos/g5.png")
knitr::include_graphics("graficos/g6.png")
```
...
knitr::include_graphics("graficos/g7.png")
knitr::include_graphics("graficos/g8.png")
```
