...
En el caso de las edades, se ha relajado la especificación para contemplar un entorno sobre los valores que sugiere el INDEC. En este sentido, sobre el total de hijos —sin distinción del tipo de hogar en el que residen— la distribución de edades comprendidas entre 3 y 7 años para uno de los hijos, y entre 7 y 11 años para el otro, captura una porción acotada de la distribución real. La mayor concentración de hijos se da entre los 12 y 15 años, con un máximo en los 14 años (4,1% del total). De hecho, los hijos de hasta 11 años representan el 34,9% del total, una proporción similar a la de quienes tienen entre 12 y 20 años (33,4%), mientras que la franja de 21 a 30 años cae al 21,0%.

</p>

<p style="text-align: justify;">

Más específicamente, <span style="background-color: #0E3E36; color: white; padding: 2px 4px;">los rangos de edad de referencia utilizados por el INDEC representan el 26,8% del total de hijos relevados por la EPH: el 12,1% tiene entre 3 y 7 años y el 14,7% entre 7 y 11 años</span>. En consecuencia, el 73,2% restante corresponde a hijos con edades diferentes de las contempladas en las canastas de referencia.
